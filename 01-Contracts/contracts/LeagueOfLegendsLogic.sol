...
contract LeagueOfLegendsLogic is MOBALogic {
    ...
    */
    ...
    function getLineup() override view public returns (uint256[] memory) {
    ...
    function setLineup(uint256[] memory athleteIds) override public {
    ...
    function getUserTotalWins() override public view returns (uint256) {
    ...
    function getUserRecord() override public view returns (uint256[8] memory) {
