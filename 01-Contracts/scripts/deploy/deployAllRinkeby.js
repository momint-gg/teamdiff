// Deploying to Rinkeby and populating Rinkeby abis and contract addresses
// Should specify network as rinkeby when deploying this
...
const main = async () => {
  ...
  contractNames.forEach(async (contractName) => {
    srcPath =
      ...
      ".json";
    backendPath =
      "../02-DApp/backend/contractscripts/contract_info/rinkebyabis/" +
      contractName +
      ".json";
