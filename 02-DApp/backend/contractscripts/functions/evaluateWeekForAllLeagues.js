...
async function main() {
  ...
  // This function takes long af to run
  // When calling other functions, if calling directly doesn't work can always use ethers.sendTransaction({...})
  let txn = await contract
    ...
    .evaluateWeekForAllLeagues({ gasPrice: 8000000000, gasLimit: 29500000 });
  await txn.wait();
  console.log('evaluateWeekForAllLeagues(): ', txn);
}
