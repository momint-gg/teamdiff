...
export default function MyLeagues({setDisplay}) {
    ...
    return (
        ...
        <Typography variant="h3" color="secondary" component="div">
            ...
            />
        <LeagueCard leagueData={exampleData} setLeague={setCurrLeague} setLeagueOpen={setLeagueOpen} /> 
        <Typography variant="h3" color="secondary" component="div" sx={{marginTop:5}}>
               PENDING LEAGUES
            </Typography>
            <hr
                style={{
