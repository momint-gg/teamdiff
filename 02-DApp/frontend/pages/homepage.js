        ...
        <div className={styles.homepage}>
            <div className={bootstrap.homepagebs}>
                ...
                <div className={styles["bg-how-it-works"]}>
                    <div className={[bootstrap["container"], bootstrap["pt-5"], bootstrap["pb-4"]].join(' ')}>
                        <div className={[bootstrap["row"], bootstrap["mb-4"]].join(' ')}>
                            <div className={[bootstrap["col-lg"], bootstrap["ps-4"], bootstrap["mb-3"], bootstrap["pe-4"], bootstrap["m-lg-3"]].join(' ')}>
                                <h1 className={[bootstrap["fw-bold"], bootstrap["mt-4"]].join(' ')}>How it Works</h1>
                            </div>
                            <div className={[bootstrap["col-lg"], bootstrap["ps-4"], bootstrap["mb-3"], bootstrap["pe-4"], bootstrap["m-lg-3"]].join(' ')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor"
                                    className={[bootstrap["bi"], bootstrap["bi-collection-fill"], styles["hiw-icon"]].join(' ')} viewBox="0 0 16 16">
                                    <path
                                ...
                                <p className={bootstrap["fs-5"]}>Mint your free starter pack to reveal 5 athlete NFT trading cards.
                                </p>
                            </div>
                            <div className={[bootstrap["col-lg"], bootstrap["ps-4"], bootstrap["mb-3"], bootstrap["pe-4"], bootstrap["m-lg-3"]].join(' ')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className={[bootstrap["bi"], bootstrap["bi-joystick"], styles["hiw-icon"]].join(' ')}
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <p className={bootstrap["fs-5"]}>Create or join leagues to challenge your friends to fantasy,
                                    on-chain and decentralized.</p>
                            </div>
                            <div className={[bootstrap["col-lg"], bootstrap["ps-4"], bootstrap["mb-3"], bootstrap["pe-4"], bootstrap["m-lg-3"]].join(' ')}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className={[bootstrap["bi"], bootstrap["bi-coin"], styles["hiw-icon"]].join(' ')}
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <h3>Win Tokens</h3>
                                <p className={bootstrap["fs-5"]}>Go head-to-head against 7 other players weekly for a chance to win pooled tokens.
                                </p>
                            </div>
                        </div>
                    </div>
